    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('pkplh.update', $pkplh->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="btn-group btn-group-toggle mb-3 btn-block" data-toggle="buttons">
                    <label class="btn btn-success">
                        <input type="radio" name="jenis_perubahan" id="jenis_perubahan1" value="perkep1"
                            @if ($pkplh->jenis_perubahan == 'perkep1') checked @endif> Perubahan Kepemilikkan
                    </label>
                    <label class="btn btn-success">
                        <input type="radio" name="jenis_perubahan" id="jenis_perubahan2" value="perkep2"
                            @if ($pkplh->jenis_perubahan == 'perkep2') checked @endif> Perubahan Kepemilikkan dan Integrasi
                        Pertek/Rintek
                    </label>
                    <label class="btn btn-success">
                        <input type="radio" name="jenis_perubahan" id="jenis_perubahan3" value="perkep3"
                            @if ($pkplh->jenis_perubahan == 'perkep3') checked @endif> Integrasi Pertek/Rintek
                    </label>
                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="pelaku_usaha_baru"
                                            value="{{ $pkplh->pelaku_usaha_baru }}"required>
                                    </div>
                                </div>
                                <div class="input-box">
                                    ...
                                    <div>
                                        <textarea class="form-control" id="nama_usaha_baru" name="nama_usaha_baru" rows="3"
                                            placeholder="Tuliskan judul nama usaha/kegiatan lengkap beserta alamat lokasi kegiatannya" required>{{ $pkplh->nama_usaha_baru }}</textarea>
                                    </div>
                                </div>
                                <div class="input-box">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div style="display: none;" class="alert alert-warning" role="alert" id="detail">
                                ...
                                <span><br> 1. Izin Lingkungan, pkplh, PKPLH, Persetujuan DELH, Persetujuan DELH</span>
                            ...
                            <input type="text" style="width: 100%" class="form-control" id="link_drive"
                                name="link_drive" placeholder="Link Google Drive" value="{{ $pkplh->link_drive }}"
                                required>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="width: 100%" class="form-control" id="pic_pemohon"
                                name="pic_pemohon" value="{{ $pkplh->pic_pemohon }}" placeholder="Nama Lengkap PIC"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" style="width: 100%" class="form-control" id="no_hp_pic"
                                name="no_hp_pic" value="{{ $pkplh->no_hp_pic }}" placeholder="Nomor Telepon PIC"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="nomor_pl" name="nomor_pl"
                                value="{{ $pkplh->nomor_pl }}" placeholder="Masukkan Nomor PL" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="date" id="tgl_pl" name="tgl_pl"
                                value="{{ $pkplh->tgl_pl }}" placeholder="yyyy/mm/dd" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" aria-label="perihal_surat" id="perihal_surat"
                                value="{{ $pkplh->perihal }}" name="perihal_surat">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" aria-label="pejabat" id="pejabat"
                                value="{{ $pkplh->pejabat_pl }}" name="pejabat_pl">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" aria-label="nomor_validasi" id="nomor_validasi"
                                value="{{ $pkplh->nomor_validasi }}" name="nomor_validasi" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="date" id="tgl_validasi" name="tgl_validasi"
                                value="{{ $pkplh->tgl_validasi }}" placeholder="yyyy/mm/dd" required>
                            <small class="text-muted">Jika belum ada, silakan isi dengan tanggal hari ini dan perbarui
                                kembali data jika sudah diproses di PTSP</small>
                        </div>
                    </div>

                    <div id="dasar_perubahan" @if ($pkplh->jenis_perubahan == 'perkep3') style="display: none;" @endif>
                        <hr>
                ...
                <div class="mb-3">
                    <!-- IL pkplh -->
                    <span><b>Sebutkan IL, pkplh, Persetujuan UKL-UPL, Persetujuan DELH, Persetujuan DPLH yang telah
                            dimiliki</b></span><br>
                    <label><b>Contoh : </b>
                        <ol>
                ...
                <div id="lampiran" @if ($pkplh->jenis_perubahan == 'perkep1') style="display: none;" @endif>
                    ...
                    if (is_string($pkplh->pertek)) {
                        if ($pkplh->pertek == 'pertek1') {
                            $pertek1 = 1;
                        } elseif ($pkplh->pertek == 'pertek2') {
                            $pertek2 = 1;
                        } elseif ($pkplh->pertek == 'pertek3') {
                            $pertek3 = 1;
                        } elseif ($pkplh->pertek == 'pertek4') {
                            $pertek4 = 1;
                        } elseif ($pkplh->pertek == 'pertek5') {
                            $pertek5 = 1;
                        } elseif ($pkplh->pertek == 'pertek6') {
                            $pertek6 = 1;
                        }
                    } else {
                        ...
                        <div class="form-group row">
                            <table border="1" width="100%">
                                ...
                                <tbody class="table-pertek1">
                                    <?php $prtk1 = 1; ?>
                                    @foreach ($pertek_pkplh as $pertek)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-control custom-checkbox ml-5">
                                <input type="checkbox" class="custom-control-input" id="rintek1" name="surat_pertek[]"
                                    value="Penyimpanan" @if ($pkplh->rintek_upload != null) checked @endif>
                            ...
                            <div class="input-group mt-1 ml-5">
                                <div id="rintek1_form" @if ($pkplh->rintek_upload == null) style="display: none" @endif>
                                    <input type="text" id="rintek1_data" value="pertek5"
                                        @if ($pkplh->rintek_upload != null) name="pertek[]" @endif hidden>
                                    <div class="input-group">
                                        ...
                                        <a class="btn btn-success ml-2 @if ($pkplh->rintek_upload == null) disabled @endif"
                                            target="_blank"
                                            href="{{ asset('storage/files/pkplh/rintek/' . $pkplh->rintek_upload) }}"><i
                            ...
                            <div class="custom-control custom-checkbox ml-5 mt-3">
                                <input type="checkbox" class="custom-control-input" id="rintek2" name="surat_pertek[]"
                                    value="Pemanfaatan" @if ($pkplh->rintek2_upload != null) checked @endif>
                            ...
                            <div class="input-group mt-1 ml-5">
                                <div id="rintek2_form" @if ($pkplh->rintek2_upload == null) style="display: none" @endif>
                                    <input type="text" id="rintek2_data" value="pertek5"
                                        @if ($pkplh->rintek2_upload != null) name="pertek[]" @endif hidden>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <a class="btn btn-success ml-2 @if ($pkplh->rintek2_upload == null) disabled @endif"
                                            target="_blank"
                                            href="{{ asset('storage/files/pkplh/rintek/' . $pkplh->rintek2_upload) }}"><i
                                                class="fas fa-download"></i></a>
                                    </div>
                                    <small class="text-muted">Format: DOCX, DOC | Ukuran Maksimal: 15 mb </small>
                                </div>
                            ...
                            <div class="custom-control custom-checkbox ml-5 mt-3">
                                <input type="checkbox" class="custom-control-input" id="rintek3" name="surat_pertek[]"
                                    value="Penimbunan" @if ($pkplh->rintek3_upload != null) checked @endif>
                            ...
                            <div class="input-group mt-1 ml-5">
                                <div id="rintek3_form" @if ($pkplh->rintek3_upload == null) style="display: none" @endif>
                                    <input type="text" id="rintek3_data" value="pertek5"
                                        @if ($pkplh->rintek3_upload != null) name="pertek[]" @endif hidden>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <a class="btn btn-success ml-2 @if ($pkplh->rintek3_upload == null) disabled @endif"
                                            target="_blank"
                                            href="{{ asset('storage/files/pkplh/rintek/' . $pkplh->rintek3_upload) }}"><i
                                                class="fas fa-download"></i></a>
                                    </div>
                                    <small class="text-muted">Format: DOCX, DOC | Ukuran Maksimal: 15 mb </small>
                                </div>
                            ...
                            <div class="custom-control custom-checkbox ml-5 mt-3">
                                <input type="checkbox" class="custom-control-input" id="rintek4" name="surat_pertek[]"
                                    value="Pengurangan" @if ($pkplh->rintek4_upload != null) checked @endif>
                            ...
                            <div class="input-group mt-1 ml-5">
                                <div id="rintek4_form" @if ($pkplh->rintek4_upload == null) style="display: none" @endif>
                                    <input type="text" id="rintek4_data" value="pertek5"
                                        @if ($pkplh->rintek4_upload != null) name="pertek[]" @endif hidden>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <a class="btn btn-success ml-2 @if ($pkplh->rintek4_upload == null) disabled @endif"
                                            target="_blank"
                                            href="{{ asset('storage/files/pkplh/rintek/' . $pkplh->rintek4_upload) }}"><i
                                                class="fas fa-download"></i></a>
                                    </div>
                                    <small class="text-muted">Format: DOCX, DOC | Ukuran Maksimal: 15 mb </small>
                                </div>
