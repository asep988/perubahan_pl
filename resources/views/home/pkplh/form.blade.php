        ...
        <form action="{{ route('pkplh.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3"> <!-- Surat Permohonan Perubahan PL & Peraturan Pemerintah Daerah -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" aria-label="nomor_validasi" placeholder='Jika belum ada, silakan isi dengan tanda "-", dan perbarui kembali data jika sudah diproses di PTSP' id="nomor_validasi" name="nomor_validasi">
