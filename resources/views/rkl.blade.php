            ...
            <table id="datatable" class="table" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $rkl -> institusi }}</td>
                        <td>
                            <form action="{{route('rkl.delete', $rkl->id)}}" method="post">@csrf
                                <a class="btn btn-warning" href="{{route('rkl.ubah', $rkl->id)}}">
                                    Edit</a>
                                <button class="btn btn-danger" onclick="return confirm('yakin mau menghapus data ini??')">
                                    Hapus</button>
                            </form>
                        </td>
                    </tr>
