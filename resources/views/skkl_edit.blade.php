    ...
    <div class="card-body">
        <form action="{{ route('skkl.update', $skkl->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <td style="padding: 20px;">
                        <div class="user-detail">
                            ...
                            <div class="input-box">
                                ...
                                <div>
                                    <input type="text" class="form-control" name="pelaku_usaha" value="{{ $skkl->pelaku_usaha }}" required>
                                </div>
                            </div>
                            <div class="input-box">
                                <label for="nama_usaha" class="form-label">Nama Usaha/Kegiatan</label>
                                <div>
                                    <input type="text" class="form-control" name="nama_usaha" value="{{ $skkl->nama_usaha }}" required>
                                </div>
                            </div>
                            <div class="input-box">
                                <label for="jenis_usaha" class="form-label">Jenis Usaha/Kegiatan</label>
                                <div>
                                    <input type="text" class="form-control" name="jenis_usaha" value="{{ $skkl->jenis_usaha }}" required>
                                </div>
                            </div>
                            <div class="input-box">
                                <label for="penanggung" class="form-label">Penanggung Jawab Usaha/Kegiatan</label>
                                <input type="text" class="form-control" name="penanggung" value="{{ $skkl->penanggung }}" required>
                            </div>
                            <div class="input-box">
                                <label for="nib" class="form-label">NIB</label>
                                <input type="text" class="form-control" name="nib" value="{{ $skkl->nib }}" required>
                            </div>
                            <div class="input-box">
                                <label for="knli" class="form-label">KBLI</label>
                                <input type="text" class="form-control" name="knli" value="{{ $skkl->knli }}" required>
                            </div>
                            <div class="input-box">
                                <label for="jabatan" class="form-label">Jabatan</label>
                                <input type="text" class="form-control" name="jabatan" value="{{ $skkl->jabatan }}" required>
                            </div>
                            <div class="input-box">
                                <label for="alamat" class="form-label">Alamat Kantor/Kegiatan</label>
                                <input type="text" class="form-control" name="alamat" value="{{ $skkl->alamat }}" required>
                            </div>
                            <div class="input-box">
                                <label for="lokasi" class="form-label">Lokasi Usaha/Kegiatan</label>
                                <input type="text" class="form-control" name="lokasi" value="{{ $skkl->lokasi }}" required>
                            </div>
                        </div>
                    </td>
                    <!-- menjadi -->
                    <td style="padding: 20px;">
                        <div class="user-detail">
                            ...
                            <div class="input-box">
                                ...
                                <div>
                                    <input type="text" class="form-control" name="nama_usaha_baru" value="{{ $skkl->nama_usaha_baru }}" required>
                                </div>
                            </div>
                            <div class="input-box">
                                <label for="jenis_usaha_baru" class="form-label">Jenis Usaha/Kegiatan</label>
                                <div>
                                    <input type="text" class="form-control" name="jenis_usaha_baru" value="{{ $skkl->jenis_usaha_baru }}" required>
                                </div>
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" class="form-control" name="knli_baru" value="{{ $skkl->knli_baru }}" required>
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" class="form-control" name="alamat_baru" value="{{ $skkl->alamat_baru }}" required>
                            </div>
                            <div class="input-box">
                                <label for="lokasi_baru" class="form-label">Lokasi Usaha/Kegiatan</label>
                                <input type="text" class="form-control" name="lokasi_baru" value="{{ $skkl->lokasi_baru }}" required>
                            </div>
                        </div>
                    </td>
                </tr>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input class="form-control" type="date" id="tgl_pl" name="tgl_pl" placeholder="yyyy/mm/dd" value="{{ $skkl->tgl_pl }}" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="perihal_surat" class="col-sm-1 col-form-label">Perihal</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" aria-label="perihal_surat" id="perihal_surat" name="perihal_surat" value="{{ $skkl->perihal }}" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-8">
                    <textarea class="form-control" id="mytextarea" aria-label="editor" name="ruang_lingkup">{!! htmlspecialchars($skkl->ruang_lingkup) !!}</textarea>
                </div>
            </div>
